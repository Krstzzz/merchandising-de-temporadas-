...
export class ProductImagesService {
  ...
  getByProduct(productId: number): Observable<BackendProductoImagen[]> {
    return this.http.get<BackendProductoImagen[]>(
  ...
  uploadImage(
    ...
    this.http
      .post<BackendProductoImagen>(`${this.apiUrl}/subir`, formData)
      .subscribe({
